...
private:
	...
	bool showAllCubeLine = false;  //显示八叉树所有边框
	bool showTool = true;
	...
	void effectiveDrawCubeLine(Octree_Struct octree);
	void drawCubeLine(Octree_Struct octree, int drawDepth);
	void drawCubeFace(Octree_Struct octree, int drawDepth);
